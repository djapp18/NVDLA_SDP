#include <sdp.h>
bool sdp::decode_sdp_DP_BS_MUL_SRC_VALUE_group0() {
sc_biguint<22> local_var_1 = 104;
...
auto& univ_var_38 = local_var_24;
return univ_var_38;
}
void sdp::update_sdp_DP_BS_MUL_SRC_VALUE_group0() {
auto local_var_1 = sdp_csb_data.range(15, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group0_d_bs_mul_operand = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DP_BS_MUL_SRC_VALUE_group0 state updates:" << std::endl;
instr_update_log << "    sdp_group0_d_bs_mul_operand => " << std::hex << "0x" << sdp_group0_d_bs_mul_operand << std::endl; 
