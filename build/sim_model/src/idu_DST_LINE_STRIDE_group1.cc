#include <sdp.h>
bool sdp::decode_sdp_DST_LINE_STRIDE_group1() {
...
auto& univ_var_28 = local_var_25;
return univ_var_28;
}
void sdp::update_sdp_DST_LINE_STRIDE_group1() {
auto local_var_1 = sdp_csb_data.range(31, 5);
auto local_var_1_nxt_holder = local_var_1;
sdp_group1_d_dst_line_stride = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DST_LINE_STRIDE_group1 state updates:" << std::endl;
instr_update_log << "    sdp_group1_d_dst_line_stride => " << std::hex << "0x" << sdp_group1_d_dst_line_stride << std::endl; 
