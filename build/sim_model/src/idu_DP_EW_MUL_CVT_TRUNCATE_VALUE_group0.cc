#include <sdp.h>
bool sdp::decode_sdp_DP_EW_MUL_CVT_TRUNCATE_VALUE_group0() {
...
auto& univ_var_70 = local_var_25;
return univ_var_70;
}
void sdp::update_sdp_DP_EW_MUL_CVT_TRUNCATE_VALUE_group0() {
auto local_var_1 = sdp_csb_data.range(5, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group0_d_ew_mul_cvt_truncate = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DP_EW_MUL_CVT_TRUNCATE_VALUE_group0 state updates:" << std::endl;
instr_update_log << "    sdp_group0_d_ew_mul_cvt_truncate => " << std::hex << "0x" << sdp_group0_d_ew_mul_cvt_truncate << std::endl; 
