...
auto& univ_var_258 = local_var_74;
return univ_var_258;
}
...
univ_var_259 = (sc_biguint<16>(local_var_9), sc_biguint<16>(local_var_16));
sc_biguint<32> local_var_18 = (univ_var_259 * local_var_6);
sc_biguint<24> local_var_19 = 0;
univ_var_260 = (sc_biguint<24>(local_var_19), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_22 = (local_var_18 >> univ_var_260);
...
univ_var_261 = (sc_biguint<16>(local_var_32), sc_biguint<16>(local_var_38));
sc_biguint<32> local_var_40 = (univ_var_261 * local_var_29);
sc_biguint<24> local_var_41 = 0;
univ_var_262 = (sc_biguint<24>(local_var_41), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_43 = (local_var_40 >> univ_var_262);
...
univ_var_263 = (sc_biguint<16>(local_var_53), sc_biguint<16>(local_var_59));
sc_biguint<32> local_var_61 = (univ_var_263 * local_var_50);
sc_biguint<24> local_var_62 = 0;
univ_var_264 = (sc_biguint<24>(local_var_62), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_64 = (local_var_61 >> univ_var_264);
...
univ_var_265 = (sc_biguint<16>(local_var_74), sc_biguint<16>(local_var_80));
sc_biguint<32> local_var_82 = (univ_var_265 * local_var_71);
sc_biguint<24> local_var_83 = 0;
univ_var_266 = (sc_biguint<24>(local_var_83), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_85 = (local_var_82 >> univ_var_266);
...
univ_var_267 = (sc_biguint<16>(local_var_95), sc_biguint<16>(local_var_101));
sc_biguint<32> local_var_103 = (univ_var_267 * local_var_92);
sc_biguint<24> local_var_104 = 0;
univ_var_268 = (sc_biguint<24>(local_var_104), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_106 = (local_var_103 >> univ_var_268);
...
univ_var_269 = (sc_biguint<16>(local_var_116), sc_biguint<16>(local_var_122));
sc_biguint<32> local_var_124 = (univ_var_269 * local_var_113);
sc_biguint<24> local_var_125 = 0;
univ_var_270 = (sc_biguint<24>(local_var_125), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_127 = (local_var_124 >> univ_var_270);
...
univ_var_271 = (sc_biguint<16>(local_var_137), sc_biguint<16>(local_var_143));
sc_biguint<32> local_var_145 = (univ_var_271 * local_var_134);
sc_biguint<24> local_var_146 = 0;
univ_var_272 = (sc_biguint<24>(local_var_146), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_148 = (local_var_145 >> univ_var_272);
...
univ_var_273 = (sc_biguint<16>(local_var_158), sc_biguint<16>(local_var_164));
sc_biguint<32> local_var_166 = (univ_var_273 * local_var_155);
sc_biguint<24> local_var_167 = 0;
univ_var_274 = (sc_biguint<24>(local_var_167), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_169 = (local_var_166 >> univ_var_274);
...
univ_var_275 = (sc_biguint<16>(local_var_179), sc_biguint<16>(local_var_185));
sc_biguint<32> local_var_187 = (univ_var_275 * local_var_176);
sc_biguint<24> local_var_188 = 0;
univ_var_276 = (sc_biguint<24>(local_var_188), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_190 = (local_var_187 >> univ_var_276);
...
univ_var_277 = (sc_biguint<16>(local_var_200), sc_biguint<16>(local_var_206));
sc_biguint<32> local_var_208 = (univ_var_277 * local_var_197);
sc_biguint<24> local_var_209 = 0;
univ_var_278 = (sc_biguint<24>(local_var_209), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_211 = (local_var_208 >> univ_var_278);
...
univ_var_279 = (sc_biguint<16>(local_var_221), sc_biguint<16>(local_var_227));
sc_biguint<32> local_var_229 = (univ_var_279 * local_var_218);
sc_biguint<24> local_var_230 = 0;
univ_var_280 = (sc_biguint<24>(local_var_230), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_232 = (local_var_229 >> univ_var_280);
...
univ_var_281 = (sc_biguint<16>(local_var_242), sc_biguint<16>(local_var_248));
sc_biguint<32> local_var_250 = (univ_var_281 * local_var_239);
sc_biguint<24> local_var_251 = 0;
univ_var_282 = (sc_biguint<24>(local_var_251), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_253 = (local_var_250 >> univ_var_282);
...
univ_var_283 = (sc_biguint<16>(local_var_263), sc_biguint<16>(local_var_269));
sc_biguint<32> local_var_271 = (univ_var_283 * local_var_260);
sc_biguint<24> local_var_272 = 0;
univ_var_284 = (sc_biguint<24>(local_var_272), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_274 = (local_var_271 >> univ_var_284);
...
univ_var_285 = (sc_biguint<16>(local_var_284), sc_biguint<16>(local_var_290));
sc_biguint<32> local_var_292 = (univ_var_285 * local_var_281);
sc_biguint<24> local_var_293 = 0;
univ_var_286 = (sc_biguint<24>(local_var_293), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_295 = (local_var_292 >> univ_var_286);
...
univ_var_287 = (sc_biguint<16>(local_var_305), sc_biguint<16>(local_var_311));
sc_biguint<32> local_var_313 = (univ_var_287 * local_var_302);
sc_biguint<24> local_var_314 = 0;
univ_var_288 = (sc_biguint<24>(local_var_314), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_316 = (local_var_313 >> univ_var_288);
...
univ_var_289 = (sc_biguint<16>(local_var_326), sc_biguint<16>(local_var_332));
sc_biguint<32> local_var_334 = (univ_var_289 * local_var_323);
sc_biguint<24> local_var_335 = 0;
univ_var_290 = (sc_biguint<24>(local_var_335), sc_biguint<8>(sdp_group0_d_bs_mul_shift_value));
sc_biguint<32> local_var_337 = (local_var_334 >> univ_var_290);
