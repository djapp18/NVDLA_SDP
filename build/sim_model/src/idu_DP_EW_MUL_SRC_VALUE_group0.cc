#include <sdp.h>
bool sdp::decode_sdp_DP_EW_MUL_SRC_VALUE_group0() {
...
auto& univ_var_64 = local_var_27;
return univ_var_64;
}
void sdp::update_sdp_DP_EW_MUL_SRC_VALUE_group0() {
auto local_var_1 = sdp_csb_data.range(31, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group0_d_ew_mul_operand = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DP_EW_MUL_SRC_VALUE_group0 state updates:" << std::endl;
instr_update_log << "    sdp_group0_d_ew_mul_operand => " << std::hex << "0x" << sdp_group0_d_ew_mul_operand << std::endl; 
