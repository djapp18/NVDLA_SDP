#include <sdp.h>
bool sdp::decode_sdp_DST_BASE_ADDR_LOW_group1() {
...
auto& univ_var_24 = local_var_27;
return univ_var_24;
}
void sdp::update_sdp_DST_BASE_ADDR_LOW_group1() {
auto local_var_1 = sdp_csb_data.range(31, 5);
auto local_var_1_nxt_holder = local_var_1;
sdp_group1_d_dst_base_addr_low = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DST_BASE_ADDR_LOW_group1 state updates:" << std::endl;
instr_update_log << "    sdp_group1_d_dst_base_addr_low => " << std::hex << "0x" << sdp_group1_d_dst_base_addr_low << std::endl; 
