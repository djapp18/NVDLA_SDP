#include <sdp.h>
bool sdp::decode_sdp_DP_EW_CFG_group1() {
...
auto& univ_var_52 = local_var_27;
return univ_var_52;
}
void sdp::update_sdp_DP_EW_CFG_group1() {
...
sdp_group1_d_ew_alu_algo = local_var_1_nxt_holder;
sdp_group1_d_ew_alu_bypass = local_var_2_nxt_holder;
sdp_group1_d_ew_bypass = local_var_3_nxt_holder;
sdp_group1_d_ew_lut_bypass = local_var_4_nxt_holder;
sdp_group1_d_ew_mul_bypass = local_var_5_nxt_holder;
sdp_group1_d_ew_mul_prelu = local_var_6_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DP_EW_CFG_group1 state updates:" << std::endl;
instr_update_log << "    sdp_group1_d_ew_alu_algo => " << std::hex << "0x" << sdp_group1_d_ew_alu_algo << std::endl; 
instr_update_log << "    sdp_group1_d_ew_alu_bypass => " << std::hex << "0x" << sdp_group1_d_ew_alu_bypass << std::endl; 
instr_update_log << "    sdp_group1_d_ew_bypass => " << std::hex << "0x" << sdp_group1_d_ew_bypass << std::endl; 
instr_update_log << "    sdp_group1_d_ew_lut_bypass => " << std::hex << "0x" << sdp_group1_d_ew_lut_bypass << std::endl; 
instr_update_log << "    sdp_group1_d_ew_mul_bypass => " << std::hex << "0x" << sdp_group1_d_ew_mul_bypass << std::endl; 
instr_update_log << "    sdp_group1_d_ew_mul_prelu => " << std::hex << "0x" << sdp_group1_d_ew_mul_prelu << std::endl; 
