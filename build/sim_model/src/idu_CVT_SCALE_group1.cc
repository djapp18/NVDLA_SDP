#include <sdp.h>
bool sdp::decode_sdp_CVT_SCALE_group1() {
...
auto& univ_var_84 = local_var_24;
return univ_var_84;
}
void sdp::update_sdp_CVT_SCALE_group1() {
auto local_var_1 = sdp_csb_data.range(15, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group1_d_cvt_scale = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "CVT_SCALE_group1 state updates:" << std::endl;
instr_update_log << "    sdp_group1_d_cvt_scale => " << std::hex << "0x" << sdp_group1_d_cvt_scale << std::endl; 
