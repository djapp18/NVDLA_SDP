#include <sdp.h>
bool sdp::decode_sdp_DATA_CUBE_HEIGHT_group1() {
sc_biguint<22> local_var_1 = 64;
...
auto& univ_var_19 = local_var_24;
return univ_var_19;
}
void sdp::update_sdp_DATA_CUBE_HEIGHT_group1() {
auto local_var_1 = sdp_csb_data.range(12, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group1_d_height = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DATA_CUBE_HEIGHT_group1 state updates:" << std::endl;
instr_update_log << "    sdp_group1_d_height => " << std::hex << "0x" << sdp_group1_d_height << std::endl; 
