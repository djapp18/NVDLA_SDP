#include <sdp.h>
bool sdp::decode_sdp_DP_EW_ALU_CFG_group1() {
sc_biguint<22> local_var_1 = 132;
...
auto& univ_var_53 = local_var_24;
return univ_var_53;
}
void sdp::update_sdp_DP_EW_ALU_CFG_group1() {
...
sdp_group1_d_ew_alu_cvt_bypass = local_var_1_nxt_holder;
sdp_group1_d_ew_alu_src = local_var_2_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DP_EW_ALU_CFG_group1 state updates:" << std::endl;
instr_update_log << "    sdp_group1_d_ew_alu_cvt_bypass => " << std::hex << "0x" << sdp_group1_d_ew_alu_cvt_bypass << std::endl; 
instr_update_log << "    sdp_group1_d_ew_alu_src => " << std::hex << "0x" << sdp_group1_d_ew_alu_src << std::endl; 
