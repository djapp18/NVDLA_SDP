#include <sdp.h>
bool sdp::decode_sdp_OP_ENABLE_group0() {
...
auto& univ_var_14 = local_var_24;
return univ_var_14;
}
void sdp::update_sdp_OP_ENABLE_group0() {
auto local_var_1 = sdp_csb_data.range(0, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group0_d_op_en = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "OP_ENABLE_group0 state updates:" << std::endl;
