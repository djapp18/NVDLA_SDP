#include <sdp.h>
bool sdp::decode_sdp_CVT_OFFSET_group0() {
...
auto& univ_var_82 = local_var_25;
return univ_var_82;
}
void sdp::update_sdp_CVT_OFFSET_group0() {
auto local_var_1 = sdp_csb_data.range(31, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group0_d_cvt_offset = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "CVT_OFFSET_group0 state updates:" << std::endl;
instr_update_log << "    sdp_group0_d_cvt_offset => " << std::hex << "0x" << sdp_group0_d_cvt_offset << std::endl; 
