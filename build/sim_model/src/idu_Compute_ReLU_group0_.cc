#include <sdp.h>
bool sdp::decode_sdp_Compute_ReLU_group0_() {
...
void sdp::update_sdp_Compute_ReLU_group0_() {
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "Compute_ReLU_group0_ state updates:" << std::endl;
