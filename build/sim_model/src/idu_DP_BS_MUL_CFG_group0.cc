#include <sdp.h>
bool sdp::decode_sdp_DP_BS_MUL_CFG_group0() {
...
auto& univ_var_37 = local_var_25;
return univ_var_37;
}
void sdp::update_sdp_DP_BS_MUL_CFG_group0() {
...
sdp_group0_d_bs_mul_shift_value = local_var_1_nxt_holder;
sdp_group0_d_bs_mul_src = local_var_2_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DP_BS_MUL_CFG_group0 state updates:" << std::endl;
instr_update_log << "    sdp_group0_d_bs_mul_shift_value => " << std::hex << "0x" << sdp_group0_d_bs_mul_shift_value << std::endl; 
instr_update_log << "    sdp_group0_d_bs_mul_src => " << std::hex << "0x" << sdp_group0_d_bs_mul_src << std::endl; 
