#include <sdp.h>
bool sdp::decode_sdp_DP_BN_ALU_SRC_VALUE_group0() {
sc_biguint<22> local_var_1 = 116;
...
auto& univ_var_44 = local_var_24;
return univ_var_44;
}
void sdp::update_sdp_DP_BN_ALU_SRC_VALUE_group0() {
auto local_var_1 = sdp_csb_data.range(15, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group0_d_bn_alu_operand = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DP_BN_ALU_SRC_VALUE_group0 state updates:" << std::endl;
instr_update_log << "    sdp_group0_d_bn_alu_operand => " << std::hex << "0x" << sdp_group0_d_bn_alu_operand << std::endl; 
