...
auto& univ_var_125 = local_var_73;
return univ_var_125;
}
...
univ_var_126 = (sc_biguint<10>(local_var_15), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_18 = (local_var_14 << univ_var_126);
univ_var_127 = (sc_biguint<16>(local_var_7), sc_biguint<16>(local_var_18));
bool local_var_20 = (local_var_6 < univ_var_127);
auto local_var_21 = (local_var_20) ? local_var_6 : univ_var_127;
...
univ_var_128 = (sc_biguint<10>(local_var_35), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_37 = (local_var_34 << univ_var_128);
univ_var_129 = (sc_biguint<16>(local_var_28), sc_biguint<16>(local_var_37));
bool local_var_39 = (local_var_27 < univ_var_129);
auto local_var_40 = (local_var_39) ? local_var_27 : univ_var_129;
...
univ_var_130 = (sc_biguint<10>(local_var_54), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_56 = (local_var_53 << univ_var_130);
univ_var_131 = (sc_biguint<16>(local_var_47), sc_biguint<16>(local_var_56));
bool local_var_58 = (local_var_46 < univ_var_131);
auto local_var_59 = (local_var_58) ? local_var_46 : univ_var_131;
...
univ_var_132 = (sc_biguint<10>(local_var_73), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_75 = (local_var_72 << univ_var_132);
univ_var_133 = (sc_biguint<16>(local_var_66), sc_biguint<16>(local_var_75));
bool local_var_77 = (local_var_65 < univ_var_133);
auto local_var_78 = (local_var_77) ? local_var_65 : univ_var_133;
...
univ_var_134 = (sc_biguint<10>(local_var_92), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_94 = (local_var_91 << univ_var_134);
univ_var_135 = (sc_biguint<16>(local_var_85), sc_biguint<16>(local_var_94));
bool local_var_96 = (local_var_84 < univ_var_135);
auto local_var_97 = (local_var_96) ? local_var_84 : univ_var_135;
...
univ_var_136 = (sc_biguint<10>(local_var_111), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_113 = (local_var_110 << univ_var_136);
univ_var_137 = (sc_biguint<16>(local_var_104), sc_biguint<16>(local_var_113));
bool local_var_115 = (local_var_103 < univ_var_137);
auto local_var_116 = (local_var_115) ? local_var_103 : univ_var_137;
...
univ_var_138 = (sc_biguint<10>(local_var_130), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_132 = (local_var_129 << univ_var_138);
univ_var_139 = (sc_biguint<16>(local_var_123), sc_biguint<16>(local_var_132));
bool local_var_134 = (local_var_122 < univ_var_139);
auto local_var_135 = (local_var_134) ? local_var_122 : univ_var_139;
...
univ_var_140 = (sc_biguint<10>(local_var_149), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_151 = (local_var_148 << univ_var_140);
univ_var_141 = (sc_biguint<16>(local_var_142), sc_biguint<16>(local_var_151));
bool local_var_153 = (local_var_141 < univ_var_141);
auto local_var_154 = (local_var_153) ? local_var_141 : univ_var_141;
...
univ_var_142 = (sc_biguint<10>(local_var_168), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_170 = (local_var_167 << univ_var_142);
univ_var_143 = (sc_biguint<16>(local_var_161), sc_biguint<16>(local_var_170));
bool local_var_172 = (local_var_160 < univ_var_143);
auto local_var_173 = (local_var_172) ? local_var_160 : univ_var_143;
...
univ_var_144 = (sc_biguint<10>(local_var_187), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_189 = (local_var_186 << univ_var_144);
univ_var_145 = (sc_biguint<16>(local_var_180), sc_biguint<16>(local_var_189));
bool local_var_191 = (local_var_179 < univ_var_145);
auto local_var_192 = (local_var_191) ? local_var_179 : univ_var_145;
...
univ_var_146 = (sc_biguint<10>(local_var_206), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_208 = (local_var_205 << univ_var_146);
univ_var_147 = (sc_biguint<16>(local_var_199), sc_biguint<16>(local_var_208));
bool local_var_210 = (local_var_198 < univ_var_147);
auto local_var_211 = (local_var_210) ? local_var_198 : univ_var_147;
...
univ_var_148 = (sc_biguint<10>(local_var_225), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_227 = (local_var_224 << univ_var_148);
univ_var_149 = (sc_biguint<16>(local_var_218), sc_biguint<16>(local_var_227));
bool local_var_229 = (local_var_217 < univ_var_149);
auto local_var_230 = (local_var_229) ? local_var_217 : univ_var_149;
...
univ_var_150 = (sc_biguint<10>(local_var_244), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_246 = (local_var_243 << univ_var_150);
univ_var_151 = (sc_biguint<16>(local_var_237), sc_biguint<16>(local_var_246));
bool local_var_248 = (local_var_236 < univ_var_151);
auto local_var_249 = (local_var_248) ? local_var_236 : univ_var_151;
...
univ_var_152 = (sc_biguint<10>(local_var_263), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_265 = (local_var_262 << univ_var_152);
univ_var_153 = (sc_biguint<16>(local_var_256), sc_biguint<16>(local_var_265));
bool local_var_267 = (local_var_255 < univ_var_153);
auto local_var_268 = (local_var_267) ? local_var_255 : univ_var_153;
...
univ_var_154 = (sc_biguint<10>(local_var_282), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_284 = (local_var_281 << univ_var_154);
univ_var_155 = (sc_biguint<16>(local_var_275), sc_biguint<16>(local_var_284));
bool local_var_286 = (local_var_274 < univ_var_155);
auto local_var_287 = (local_var_286) ? local_var_274 : univ_var_155;
...
univ_var_156 = (sc_biguint<10>(local_var_301), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_303 = (local_var_300 << univ_var_156);
univ_var_157 = (sc_biguint<16>(local_var_294), sc_biguint<16>(local_var_303));
bool local_var_305 = (local_var_293 < univ_var_157);
auto local_var_306 = (local_var_305) ? local_var_293 : univ_var_157;
