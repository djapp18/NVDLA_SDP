#include <sdp.h>
bool sdp::decode_sdp_DP_BN_MUL_CFG_group0() {
sc_biguint<22> local_var_1 = 120;
...
auto& univ_var_46 = local_var_24;
return univ_var_46;
}
void sdp::update_sdp_DP_BN_MUL_CFG_group0() {
auto local_var_1 = sdp_csb_data.range(15, 8);
auto local_var_1_nxt_holder = local_var_1;
auto local_var_2 = sdp_csb_data.range(0, 0);
auto local_var_2_nxt_holder = local_var_2;
sdp_group0_d_bn_mul_shift_value = local_var_1_nxt_holder;
sdp_group0_d_bn_mul_src = local_var_2_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DP_BN_MUL_CFG_group0 state updates:" << std::endl;
instr_update_log << "    sdp_group0_d_bn_mul_shift_value => " << std::hex << "0x" << sdp_group0_d_bn_mul_shift_value << std::endl; 
instr_update_log << "    sdp_group0_d_bn_mul_src => " << std::hex << "0x" << sdp_group0_d_bn_mul_src << std::endl; 
