...
auto& univ_var_135 = local_var_75;
return univ_var_135;
}
void sdp::update_sdp_Compute_Add_group0() {
sc_biguint<16> local_var_0 = 0;
auto local_var_2 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_136 = (sc_biguint<10>(local_var_8), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_11 = (local_var_7 << univ_var_136);
univ_var_137 = (sc_biguint<16>(local_var_0), sc_biguint<16>(local_var_11));
auto univ_var_137_nxt_holder = univ_var_137;
sc_biguint<16> local_var_13 = 0;
auto local_var_14 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_138 = (sc_biguint<10>(local_var_20), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_22 = (local_var_19 << univ_var_138);
univ_var_139 = (sc_biguint<16>(local_var_13), sc_biguint<16>(local_var_22));
auto univ_var_139_nxt_holder = univ_var_139;
sc_biguint<16> local_var_24 = 0;
auto local_var_25 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_140 = (sc_biguint<10>(local_var_31), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_33 = (local_var_30 << univ_var_140);
univ_var_141 = (sc_biguint<16>(local_var_24), sc_biguint<16>(local_var_33));
auto univ_var_141_nxt_holder = univ_var_141;
sc_biguint<16> local_var_35 = 0;
auto local_var_36 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_142 = (sc_biguint<10>(local_var_42), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_44 = (local_var_41 << univ_var_142);
univ_var_143 = (sc_biguint<16>(local_var_35), sc_biguint<16>(local_var_44));
auto univ_var_143_nxt_holder = univ_var_143;
sc_biguint<16> local_var_46 = 0;
auto local_var_47 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_144 = (sc_biguint<10>(local_var_53), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_55 = (local_var_52 << univ_var_144);
univ_var_145 = (sc_biguint<16>(local_var_46), sc_biguint<16>(local_var_55));
auto univ_var_145_nxt_holder = univ_var_145;
sc_biguint<16> local_var_57 = 0;
auto local_var_58 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_146 = (sc_biguint<10>(local_var_64), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_66 = (local_var_63 << univ_var_146);
univ_var_147 = (sc_biguint<16>(local_var_57), sc_biguint<16>(local_var_66));
auto univ_var_147_nxt_holder = univ_var_147;
sc_biguint<16> local_var_68 = 0;
auto local_var_69 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_148 = (sc_biguint<10>(local_var_75), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_77 = (local_var_74 << univ_var_148);
univ_var_149 = (sc_biguint<16>(local_var_68), sc_biguint<16>(local_var_77));
auto univ_var_149_nxt_holder = univ_var_149;
sc_biguint<16> local_var_79 = 0;
auto local_var_80 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_150 = (sc_biguint<10>(local_var_86), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_88 = (local_var_85 << univ_var_150);
univ_var_151 = (sc_biguint<16>(local_var_79), sc_biguint<16>(local_var_88));
auto univ_var_151_nxt_holder = univ_var_151;
sc_biguint<16> local_var_90 = 0;
auto local_var_91 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_152 = (sc_biguint<10>(local_var_97), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_99 = (local_var_96 << univ_var_152);
univ_var_153 = (sc_biguint<16>(local_var_90), sc_biguint<16>(local_var_99));
auto univ_var_153_nxt_holder = univ_var_153;
sc_biguint<16> local_var_101 = 0;
auto local_var_102 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_154 = (sc_biguint<10>(local_var_108), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_110 = (local_var_107 << univ_var_154);
univ_var_155 = (sc_biguint<16>(local_var_101), sc_biguint<16>(local_var_110));
auto univ_var_155_nxt_holder = univ_var_155;
sc_biguint<16> local_var_112 = 0;
auto local_var_113 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_156 = (sc_biguint<10>(local_var_119), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_121 = (local_var_118 << univ_var_156);
univ_var_157 = (sc_biguint<16>(local_var_112), sc_biguint<16>(local_var_121));
auto univ_var_157_nxt_holder = univ_var_157;
...
univ_var_158 = (sc_biguint<10>(local_var_130), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_132 = (local_var_129 << univ_var_158);
univ_var_159 = (sc_biguint<16>(local_var_123), sc_biguint<16>(local_var_132));
auto univ_var_159_nxt_holder = univ_var_159;
sc_biguint<16> local_var_134 = 0;
auto local_var_135 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_160 = (sc_biguint<10>(local_var_141), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_143 = (local_var_140 << univ_var_160);
univ_var_161 = (sc_biguint<16>(local_var_134), sc_biguint<16>(local_var_143));
auto univ_var_161_nxt_holder = univ_var_161;
sc_biguint<16> local_var_145 = 0;
auto local_var_146 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_162 = (sc_biguint<10>(local_var_152), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_154 = (local_var_151 << univ_var_162);
univ_var_163 = (sc_biguint<16>(local_var_145), sc_biguint<16>(local_var_154));
auto univ_var_163_nxt_holder = univ_var_163;
sc_biguint<16> local_var_156 = 0;
auto local_var_157 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_164 = (sc_biguint<10>(local_var_163), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_165 = (local_var_162 << univ_var_164);
univ_var_165 = (sc_biguint<16>(local_var_156), sc_biguint<16>(local_var_165));
auto univ_var_165_nxt_holder = univ_var_165;
sc_biguint<16> local_var_167 = 0;
auto local_var_168 = sdp_group0_d_bs_alu_src.range(0, 0);
...
univ_var_166 = (sc_biguint<10>(local_var_174), sc_biguint<6>(sdp_group0_d_bs_alu_shift_value));
sc_biguint<16> local_var_176 = (local_var_173 << univ_var_166);
univ_var_167 = (sc_biguint<16>(local_var_167), sc_biguint<16>(local_var_176));
auto univ_var_167_nxt_holder = univ_var_167;
sdp_pdp_output_0 = univ_var_137_nxt_holder;
sdp_pdp_output_1 = univ_var_139_nxt_holder;
sdp_pdp_output_10 = univ_var_141_nxt_holder;
sdp_pdp_output_11 = univ_var_143_nxt_holder;
sdp_pdp_output_12 = univ_var_145_nxt_holder;
sdp_pdp_output_13 = univ_var_147_nxt_holder;
sdp_pdp_output_14 = univ_var_149_nxt_holder;
sdp_pdp_output_15 = univ_var_151_nxt_holder;
sdp_pdp_output_2 = univ_var_153_nxt_holder;
sdp_pdp_output_3 = univ_var_155_nxt_holder;
sdp_pdp_output_4 = univ_var_157_nxt_holder;
sdp_pdp_output_5 = univ_var_159_nxt_holder;
sdp_pdp_output_6 = univ_var_161_nxt_holder;
sdp_pdp_output_7 = univ_var_163_nxt_holder;
sdp_pdp_output_8 = univ_var_165_nxt_holder;
sdp_pdp_output_9 = univ_var_167_nxt_holder;
