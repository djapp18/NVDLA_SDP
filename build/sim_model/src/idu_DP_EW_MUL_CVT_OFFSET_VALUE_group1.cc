#include <sdp.h>
bool sdp::decode_sdp_DP_EW_MUL_CVT_OFFSET_VALUE_group1() {
...
auto& univ_var_67 = local_var_27;
return univ_var_67;
}
void sdp::update_sdp_DP_EW_MUL_CVT_OFFSET_VALUE_group1() {
auto local_var_1 = sdp_csb_data.range(31, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group1_d_ew_mul_cvt_offset = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DP_EW_MUL_CVT_OFFSET_VALUE_group1 state updates:" << std::endl;
instr_update_log << "    sdp_group1_d_ew_mul_cvt_offset => " << std::hex << "0x" << sdp_group1_d_ew_mul_cvt_offset << std::endl; 
