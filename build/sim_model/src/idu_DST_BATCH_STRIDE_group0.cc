#include <sdp.h>
bool sdp::decode_sdp_DST_BATCH_STRIDE_group0() {
...
auto& univ_var_78 = local_var_27;
return univ_var_78;
}
void sdp::update_sdp_DST_BATCH_STRIDE_group0() {
auto local_var_1 = sdp_csb_data.range(31, 5);
auto local_var_1_nxt_holder = local_var_1;
sdp_group0_d_dst_batch_stride = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DST_BATCH_STRIDE_group0 state updates:" << std::endl;
instr_update_log << "    sdp_group0_d_dst_batch_stride => " << std::hex << "0x" << sdp_group0_d_dst_batch_stride << std::endl; 
