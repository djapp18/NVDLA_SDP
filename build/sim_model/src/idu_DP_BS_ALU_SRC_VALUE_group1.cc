#include <sdp.h>
bool sdp::decode_sdp_DP_BS_ALU_SRC_VALUE_group1() {
sc_biguint<22> local_var_1 = 96;
...
auto& univ_var_35 = local_var_24;
return univ_var_35;
}
void sdp::update_sdp_DP_BS_ALU_SRC_VALUE_group1() {
auto local_var_1 = sdp_csb_data.range(15, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group1_d_bs_alu_operand = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DP_BS_ALU_SRC_VALUE_group1 state updates:" << std::endl;
instr_update_log << "    sdp_group1_d_bs_alu_operand => " << std::hex << "0x" << sdp_group1_d_bs_alu_operand << std::endl; 
