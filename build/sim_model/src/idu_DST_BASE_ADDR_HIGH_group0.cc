#include <sdp.h>
bool sdp::decode_sdp_DST_BASE_ADDR_HIGH_group0() {
sc_biguint<22> local_var_1 = 76;
...
auto& univ_var_24 = local_var_24;
return univ_var_24;
}
void sdp::update_sdp_DST_BASE_ADDR_HIGH_group0() {
auto local_var_1 = sdp_csb_data.range(31, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group0_d_dst_base_addr_high = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DST_BASE_ADDR_HIGH_group0 state updates:" << std::endl;
instr_update_log << "    sdp_group0_d_dst_base_addr_high => " << std::hex << "0x" << sdp_group0_d_dst_base_addr_high << std::endl; 
