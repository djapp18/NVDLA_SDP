#include <sdp.h>
bool sdp::decode_sdp_Compute_ReLU_group1_() {
...
auto local_var_11 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_21 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_31 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_41 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_51 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_61 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_71 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_81 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_91 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_101 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_111 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_121 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_141 = sdp_group1_d_flying_mode.range(0, 0);
...
auto local_var_151 = sdp_group1_d_flying_mode.range(0, 0);
...
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "Compute_ReLU_group1_ state updates:" << std::endl;
