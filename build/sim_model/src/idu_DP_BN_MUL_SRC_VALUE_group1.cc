#include <sdp.h>
bool sdp::decode_sdp_DP_BN_MUL_SRC_VALUE_group1() {
...
auto& univ_var_50 = local_var_27;
return univ_var_50;
}
void sdp::update_sdp_DP_BN_MUL_SRC_VALUE_group1() {
auto local_var_1 = sdp_csb_data.range(15, 0);
auto local_var_1_nxt_holder = local_var_1;
sdp_group1_d_bn_mul_operand = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "DP_BN_MUL_SRC_VALUE_group1 state updates:" << std::endl;
instr_update_log << "    sdp_group1_d_bn_mul_operand => " << std::hex << "0x" << sdp_group1_d_bn_mul_operand << std::endl; 
