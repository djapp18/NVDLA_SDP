...
auto& univ_var_284 = local_var_13;
return univ_var_284;
}
void sdp::update_sdp_Read_LUT_LO() {
sc_biguint<16> local_var_0 = 0;
univ_var_285 = (sc_biguint<16>(local_var_0), sc_biguint<16>(sdp_s_lut_data));
bool local_var_4 = (univ_var_285 == sdp_s_lut_lo_start);
bool local_var_5 = (univ_var_285 < sdp_s_lut_lo_start);
bool local_var_6 = (local_var_4 | local_var_5);
sc_biguint<32> local_var_7 = 0;
sc_biguint<16> local_var_8 = 0;
univ_var_286 = (sc_biguint<16>(local_var_8), sc_biguint<16>(sdp_s_lut_data));
sc_biguint<32> local_var_10 = (univ_var_286 - sdp_s_lut_lo_start);
sc_biguint<24> local_var_11 = 0;
univ_var_287 = (sc_biguint<24>(local_var_11), sc_biguint<8>(sdp_s_lut_lo_index_select));
sc_biguint<32> local_var_14 = (local_var_10 >> univ_var_287);
...
univ_var_288 = (sc_biguint<24>(local_var_21), sc_biguint<8>(sdp_s_lut_lo_index_select));
sc_biguint<32> local_var_23 = (local_var_20 << univ_var_288);
...
univ_var_289 = (sc_biguint<24>(local_var_27), sc_biguint<8>(sdp_s_lut_lo_index_select));
sc_biguint<32> local_var_29 = 35;
sc_biguint<32> local_var_30 = (univ_var_289 - local_var_29);
...
univ_var_290 = (sc_biguint<16>(local_var_35), sc_biguint<16>(sdp_s_lut_data));
bool local_var_37 = (univ_var_290 == sdp_s_lut_lo_start);
bool local_var_38 = (univ_var_290 < sdp_s_lut_lo_start);
...
univ_var_291 = (sc_biguint<16>(local_var_49), sc_biguint<16>(sdp_s_lut_data));
bool local_var_51 = (univ_var_291 == sdp_s_lut_lo_start);
bool local_var_52 = (univ_var_291 < sdp_s_lut_lo_start);
...
univ_var_292 = (sc_biguint<16>(local_var_63), sc_biguint<16>(sdp_s_lut_data));
bool local_var_65 = (univ_var_292 == sdp_s_lut_lo_start);
bool local_var_66 = (univ_var_292 < sdp_s_lut_lo_start);
