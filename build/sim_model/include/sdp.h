...
SC_MODULE(sdp) {
  ...
  sc_biguint<32> sdp_test2;
  sc_biguint<20> sdp_test;
  ...
  sc_biguint<16> univ_var_93;
  sc_biguint<32> univ_var_94;
  sc_biguint<16> univ_var_95;
  ...
  bool valid_sdp();
  void store_258(std::map<sc_biguint<7>, sc_biguint<16>>& tmp_memory);
  void store_260(std::map<sc_biguint<9>, sc_biguint<16>>& tmp_memory);
  SC_HAS_PROCESS(sdp);
