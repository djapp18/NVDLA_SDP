...
SC_MODULE(sdp) {
  ...
  bool valid_sdp();
  void store_261(std::map<sc_biguint<7>, sc_biguint<16>>& tmp_memory);
  void store_263(std::map<sc_biguint<9>, sc_biguint<16>>& tmp_memory);
  SC_HAS_PROCESS(sdp);
